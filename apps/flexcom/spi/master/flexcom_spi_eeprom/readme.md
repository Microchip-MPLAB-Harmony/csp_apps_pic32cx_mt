...
- Plug the [EEPROM 4 Click board](https://www.mikroe.com/eeprom-4-click) into the MikroBus-1 socket of the [PIC32CXMTG-Development Board](https://www.microchip.com/en-us/development-tool/EV11K09A)
- Connect the Debug USB port on the board to the computer using a micro USB cable

### Setting up [PIC32CXMTSH-Development Board](https://www.microchip.com/en-us/development-tool/PIC32CXMTSH-DB#Related%20Tools)

- Plug an [EEPROM 4 Click board](https://www.mikroe.com/eeprom-4-click) into the MikroBus socket of the [PIC32CXMTSH-Development Board](https://www.microchip.com/en-us/development-tool/PIC32CXMTSH-DB#Related%20Tools)
- Connect the Debug USB port on the board to the computer using a micro USB cable
