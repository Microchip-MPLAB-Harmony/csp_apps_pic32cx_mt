    ...
    while(1)
    {
        ...
        switch (state)
        {
            case APP_STATE_INITIALIZE:
                ...
                FLEXCOM3_SPI_CallbackRegister(SPIEventHandler, (uintptr_t) 0);
            ...
            case APP_STATE_EEPROM_WRITE:
                if (isTransferDone == true)
                {
                    ...
                    EEPROM_CS_Clear();
                    FLEXCOM3_SPI_Write(txData, (4 + EEPROM_DATA_LEN));
            ...
            case APP_STATE_EEPROM_READ_STATUS:
                if (isTransferDone == true)
                {
                    ...
                    EEPROM_CS_Clear();
                    FLEXCOM3_SPI_WriteRead(txData, 1, rxData, 2);
            ...
            case APP_STATE_EEPROM_READ:
                ...
                EEPROM_CS_Clear();
                FLEXCOM3_SPI_WriteRead(txData, 4, rxData, (4 + EEPROM_DATA_LEN));
